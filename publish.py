...
class Publish:
    ...
    def generate_paper(self, chan, authors):
        ...
        if len(authors) > 5 or len(authors) == 0:
            ...
            targeturl = ''
            targeturl += 'http://pdos.csail.mit.edu/cgi-bin/sciredirect.cgi?author={}&author={}&author={}&author={}&author={}'.format(
            ...
            if (url == None):
                self.irc.privmsg(
                    chan, "This is immoral! I can't bear the burden of this..")
            else:
